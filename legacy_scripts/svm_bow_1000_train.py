...
# BoW
bow = CountVectorizer(max_features=1000)  # Replaced TfidfVectorizer with CountVectorizer
...
print("SVM BoW 1000 Model Evaluation")
...
joblib.dump(bow, 'Model\Svm\\bow_svm_vectorizer.pkl')
