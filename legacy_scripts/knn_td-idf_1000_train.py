...
# 20% random samples from training set
...
param_grid = {
    ...
    'weights': ['uniform', 'distance', 'weight']   
}
...
print(f"Optional parameters: {best_params}")
print(f"Best accuracy from cross-validation: {best_score:.4f}")
...
print("KNN TF-IDF 1000 Model Evaluation")
