...
print("Random Forest TF-IDF 1000 Model Evaluation")
...
model_path = os.path.join(script_dir, 'Model', 'Rf', 'random_forest_spam_model.pkl')
vectorizer_path = os.path.join(script_dir, 'Model', 'Rf', 'tfidf_vectorizer_1000.pkl')
